...
{    
  ...
  // vykus pro BLTouch
  translate([0,-part_length/2 + carriage_width/2 + extra_length - MGN12_holes[1][1],carriage_height/2 -mount_screw_offset - 30/2]) cube([MGN12_holes[0][0] + MGN12_holes[1][0],M3_head_D,30],center=true);
  translate([0,part_length/2+M3_head_D/2,carriage_height/2 -mount_screw_offset - 30/2]) cube(size=[MGN12_holes[0][0] + MGN12_holes[1][0]+M3_head_D, part_length, 30], center=true);
 ...
 translate([carriage_length/2 - Z_probe_D/2,-part_length/2,0]) cube([carriage_length,2*extra_length - 3,carriage_height + 1],center=true);
  ...
  // Vyrez pro BLTouch
  //translate([0,0,0]) cube(size=[BLT_body_w, part_length+1, BLT_body_h], center=true); //cylinder(d=Z_probe_D,h=part_length + 1,$fn=64,center=true);
